...
def user_input_features():
    ...
    외벽= st.sidebar.slider('외벽', 0.0, 6.0, 0.240 )
    지붕 = st.sidebar.slider('지붕', 0.0, 6.0, 1.050)
    바닥 = st.sidebar.slider('바닥', 0.0, 6.0, 1.740)
    창호열관류율 = st.sidebar.slider('창호열관류율', 0.0, 6.0, 3.1 )
    SHGC = st.sidebar.slider('SHGC', 0.0, 2.0, 0.688)
    문열관류율 = st.sidebar.slider('문열관류율', 0.0, 6.0, 3.8 )
    보일러효율 = st.sidebar.slider('보일러효율', 0.0, 100.0, 83.0)
    난방효율 = st.sidebar.slider('난방효율', 0.0, 7.0, 3.5)
    냉방효율 = st.sidebar.slider('냉방효율', 0.0, 7.0, 3.45 )
    급탕효율 = st.sidebar.slider('급탕효율', 0.0, 100.0, 82.5 )
    조명밀도 = st.sidebar.slider('조명밀도',  0.0, 20.0, 6.0, )
...
def user_input_features2():
    # ACH50 = st.sidebar.slider('ACH50', X_data.ACH50.min(), X_data.ACH50.max(), X_data.ACH50.mean())
    외벽_2= st.sidebar.slider('외벽_2', 0.0, 2.0, 0.170 )
    지붕_2 = st.sidebar.slider('지붕_2', 0.0, 2.0, 0.206)
    바닥_2 = st.sidebar.slider('바닥_2', 0.0, 2.0, 0.237)
    창호열관류율_2 = st.sidebar.slider('창호열관류율_2', 0.0, 4.0, 1.3 )
    SHGC_2 = st.sidebar.slider('SHGC_2', 0.0, 2.0, 0.230)
    문열관류율_2 = st.sidebar.slider('문열관류율_2', 0.0, 4.0, 1.5 )
    보일러효율_2 = st.sidebar.slider('보일러효율_2', 0.0, 100.0, 100.0)
    난방효율_2 = st.sidebar.slider('난방효율_2', 0.0, 7.0, 4.5)
    냉방효율_2 = st.sidebar.slider('냉방효율_2', 0.0, 7.0, 4.5 )
    급탕효율_2 = st.sidebar.slider('급탕효율_2', 0.0, 100.0, 100.0 )
    조명밀도_2 = st.sidebar.slider('조명밀도_2',  0.0, 20.0, 4.0, )
...
df_concat2['MW/m2'] = df_concat2['kWh/m2'] / 1000
# df_concat2
...
df_concat2.loc[cond3_1&cond4,'tCO2eq_Elec/m2'] = df_concat2['MW/m2'] * base_cooling_elec_ratio * tCO2eq_elec_co
df_concat2.loc[cond3_1&cond4,'tCO2eq_LPG/m2'] = df_concat2['MW/m2'] * base_cooling_LNG_ratio * tCO2eq_LNG_co
df_concat2.loc[cond3_1&cond4,'tCO2eq_LNG/m2'] = df_concat2['MW/m2'] * base_cooling_LPG_ratio  * tCO2eq_LPG_co
df_concat2.loc[cond3_1&cond4,'tCO2eq_LOil/m2'] = df_concat2['MW/m2'] * base_cooling_LOil_ratio * tCO2eq_LOil_co
...
df_concat2.loc[cond3_1&cond5,'tCO2eq_Elec/m2'] = df_concat2['MW/m2'] * alt_cooling_elec_ratio * tCO2eq_elec_co
df_concat2.loc[cond3_1&cond5,'tCO2eq_LPG/m2'] = df_concat2['MW/m2'] * alt_cooling_LNG_ratio * tCO2eq_LNG_co
df_concat2.loc[cond3_1&cond5,'tCO2eq_LNG/m2'] = df_concat2['MW/m2'] * alt_cooling_LPG_ratio  * tCO2eq_LPG_co
df_concat2.loc[cond3_1&cond5,'tCO2eq_LOil/m2'] = df_concat2['MW/m2'] * alt_cooling_LOil_ratio * tCO2eq_LOil_co
...
df_concat2.loc[cond7|cond8,'tCO2eq_Elec/m2'] = df_concat2['MW/m2'] * tCO2eq_elec_co
