...
def user_input_features():
    ...
    외벽= st.sidebar.slider('외벽', 0.0, 6.0, 0.466 )
    지붕 = st.sidebar.slider('지붕', 0.0, 6.0, 0.264)
    바닥 = st.sidebar.slider('바닥', 0.0, 6.0, 0.466)
    창호열관류율 = st.sidebar.slider('창호열관류율', 0.0, 6.0, 3.0 )
    SHGC = st.sidebar.slider('SHGC', 0.0, 2.0, 0.688)
    문열관류율 = st.sidebar.slider('문열관류율', 0.0, 6.0, 3.0 )
