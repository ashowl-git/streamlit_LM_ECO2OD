...
base_heat_elec_ratio = col1.number_input('BASE_ 난방용_전기비율',min_value=0.00, max_value=1.00, value=0.8)
base_heat_LNG_ratio = col2.number_input('BASE_ 난방용_LNG비율',min_value=0, max_value=1, value=0.8)
base_heat_LPG_ratio = col3.number_input('BASE_ 난방용_LPG비율',min_value=0, max_value=1, value=0.8)
base_heat_LOil_ratio = col4.number_input('BASE_ 난방용_등유비율',min_value=0, max_value=1, value=0.8)

col1, col2, col3, col4 = st.columns(4)
base_DHW_elec_ratio = col1.number_input('BASE_ 급탕용_전기비율',min_value=0, max_value=1, value=0.8)
base_DHW_LNG_ratio = col2.number_input('BASE_ 급탕용_LNG비율',min_value=0, max_value=1, value=0.8)
base_DHW_LPG_ratio = col3.number_input('BASE_ 급탕용_LPG비율',min_value=0, max_value=1, value=0.8)
base_DHW_LOil_ratio = col4.number_input('BASE_ 급탕용_등유비율',min_value=0, max_value=1, value=0.8)

st.subheader('ALT_ 난방및 급탕을 위한 연료종류의 비율')

col1, col2, col3, col4 = st.columns(4)
alt_heat_elec_ratio = col1.number_input('alt_ 난방용_전기비율',min_value=0, max_value=1, value=0.8)
alt_heat_LNG_ratio = col2.number_input('alt_ 난방용_LNG비율',min_value=0, max_value=1, value=0.8)
alt_heat_LPG_ratio = col3.number_input('alt_ 난방용_LPG비율',min_value=0, max_value=1, value=0.8)
alt_heat_LOil_ratio = col4.number_input('alt_ 난방용_등유비율',min_value=0, max_value=1, value=0.8)

col1, col2, col3, col4 = st.columns(4)
alt_DHW_elec_ratio = col1.number_input('alt_ 급탕용_전기비율',min_value=0, max_value=1, value=0.8)
alt_DHW_LNG_ratio = col2.number_input('alt_ 급탕용_LNG비율',min_value=0, max_value=1, value=0.8)
alt_DHW_LPG_ratio = col3.number_input('alt_ 급탕용_LPG비율',min_value=0, max_value=1, value=0.8)
alt_DHW_LOil_ratio = col4.number_input('alt_ 급탕용_등유비율',min_value=0, max_value=1, value=0.8)
