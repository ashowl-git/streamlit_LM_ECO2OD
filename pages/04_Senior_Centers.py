...
def user_input_features():
    ...
    외벽= st.sidebar.slider('외벽', 0.0, 6.0, 0.581 )
    지붕 = st.sidebar.slider('지붕', 0.0, 6.0, 0.407)
    바닥 = st.sidebar.slider('바닥', 0.0, 6.0, 0.581)
    창호열관류율 = st.sidebar.slider('창호열관류율', 0.0, 6.0, 3.372 )
    SHGC = st.sidebar.slider('SHGC', 0.0, 2.0, 0.774)
    문열관류율 = st.sidebar.slider('문열관류율', 0.0, 6.0, 3.372 )
    난방효율 = st.sidebar.slider('난방효율', 0.0, 100.0, 80.0)
    냉방효율 = st.sidebar.slider('냉방효율', 0.0, 7.0, 3.0 )
    급탕효율 = st.sidebar.slider('급탕효율', 0.0, 100.0, 80.0 )
    조명밀도 = st.sidebar.slider('조명밀도',  0.0, 20.0, 15.0, )
...
def user_input_features2():
    ...
    난방효율_2 = st.sidebar.slider('난방효율_2', 0.0, 100.0, 100.0)
