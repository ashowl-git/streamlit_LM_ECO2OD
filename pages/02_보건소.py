...
def user_input_features():
    ...
    바닥 = st.sidebar.slider('바닥', 0.0, 2.0, 0.480)
    창호열관류율 = st.sidebar.slider('창호열관류율', 0.0, 4.0, 3.2 )
    SHGC = st.sidebar.slider('SHGC', 0.0, 2.0, 0.688)
    문열관류율 = st.sidebar.slider('문열관류율', 0.0, 4.0, 2.8 )
    난방효율 = st.sidebar.slider('난방효율', 0.0, 100.0, 87.0)
    냉방효율 = st.sidebar.slider('냉방효율', 0.0, 7.0, 3.9 )
    급탕효율 = st.sidebar.slider('급탕효율', 0.0, 100.0, 90.0 )
    조명밀도 = st.sidebar.slider('조명밀도',  0.0, 20.0, 10.6, )
...
def user_input_features2():
    ...
    SHGC_2 = st.sidebar.slider('SHGC_2', 0.0, 2.0, 0.23)
    ...
    조명밀도_2 = st.sidebar.slider('조명밀도_2',  0.0, 20.0, 6.5, )
